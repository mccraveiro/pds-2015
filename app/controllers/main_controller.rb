...
class MainController < ApplicationController
  ...
  def get_data(city = "", year = "", month = "", domain = "", subdomain = "", nature = "")
    ...
    months.map { |m| call_api(city, year, m, domain, subdomain, nature) }
  end

  private
  def call_api(city, year, month, domain, subdomain, nature)
